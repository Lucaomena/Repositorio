        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#certificados" className={activeLink === 'certificados' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('footer')}>certificados</Nav.Link>
            </Nav>
